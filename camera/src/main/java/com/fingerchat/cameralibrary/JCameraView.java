...
import com.fingerchat.cameralibrary.listener.TypeListener;
import com.fingerchat.cameralibrary.state.CameraMachine;
...
import com.fingerchat.cameralibrary.view.CameraView;
...
//                    Log.i("CJT", "result = " + (result - firstTouchLength));
    ...
    public int getRecordedTime() {
        return mCaptureLayout.getRecordedTime();
    }
