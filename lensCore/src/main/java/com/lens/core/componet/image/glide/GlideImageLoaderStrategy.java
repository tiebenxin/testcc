 ...
 * 全局网络图片加载 请使用 {@link com.lens.core.componet.image.ImageLoader}
 * <p>
 * 如需要使用其他图片加载引擎 ， 请自定义ImageLoaderStrategy 并指定 {@link  com.lens.core.componet.image.ImageLoader#getLoader()}
