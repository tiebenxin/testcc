...
public class RestContact implements Serializable {
  ...
  private String fgJID;

  public String getFgJID() {
    return fgJID;
  }

  public void setFgJID(String fgJID) {
    this.fgJID = fgJID;
  }
  ...
  public String toString() {
    return "RestContact [id=" + id + ", name=" + name + ", ownerId=" + ownerId + ", email=" + email
        ...
        + ", lastModifiedTime=" + lastModifiedTime + ", userName=" + userName + ", orgName="
        + orgName
        + ", h323ConfNumber=" + h323ConfNumber + ", sipConfNumber=" + sipConfNumber + ", pstn="
        + pstn
        + ", callNumber=" + callNumber + ", imageURL=" + imageURL + ", status=" + status + ", fgJID=" + fgJID + "]";
  }
