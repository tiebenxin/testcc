...
public class NoteStringUtils {
  ...
  public static final String IDENTIFER_OF_IMG = "!!!_@@-95243ujgds0g34";

  /***
   *聊天
   *HnlensImage/Message/LensFSFiles/Image/0/96/e0/096e0bbf97c490324993ba73b58fcfbf_b.png&乡味柴火渔馆(星沙店),28.225361,113.089327
   *
   * 笔记
   *乡味柴火渔馆(星沙店),28.225361,113.089327&HnlensImage/Message/LensFSFiles/Image/0/96/e0/096e0bbf97c490324993ba73b58fcfbf_b.png
   *
   * */
  public static String divideImagePath(String content, boolean isChat) {
    try {
      String[] path = content.split(SPLIT_AND);
      if (path.length > 1) {
        return isChat ? path[0] : path[1];
      }
    } catch (Exception e) {
      e.printStackTrace();
    }
