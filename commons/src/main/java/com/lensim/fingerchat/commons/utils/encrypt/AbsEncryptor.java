...
//        String saltHex = MyApplication.getInstance().getString(key,null);
        String saltHex = SPSaveHelper.getStringValue(key, null);
        ...
        if (salt == null) {
            ...
            SPSaveHelper.getStringValue(key, saltHex);
//            MyApplication.getInstance().saveString(key,saltHex);
//            if (pref != null) {
