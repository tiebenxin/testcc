...
/**
 * Created by LY309313 on 2017/3/21.
 */
...
//        mContext = context;
  ...
  public static ScreenShotListenManager newInstance() {
    assertInMainThread();
    return new ScreenShotListenManager();
  }
  ...
  public void startListen() {
    ...
    // 注册内容观察者
    ContextHelper.getContext().getContentResolver().registerContentObserver(
  ...
  public void stopListen() {
    ...
    if (mInternalObserver != null) {
      try {
        ContextHelper.getContext().getContentResolver()
  ...
  private void handleMediaContentChange(Uri contentUri) {
    ...
    try {
      ...
      cursor = ContextHelper.getContext().getContentResolver().query(
          contentUri,
  ...
  private Point getRealScreenSize() {
    ...
    try {
      ...
      WindowManager windowManager = (WindowManager) ContextHelper.getContext()
