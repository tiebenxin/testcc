...
//    }
    ...
    public static DisplayMetrics getDisplayMetrics() {
        ...
        ((WindowManager) ContextHelper.getContext().getSystemService(
    ...
    public static boolean hasBigScreen() {
        ...
        if (_hasBigScreen == null) {
            boolean flag1;
            if ((0xf & ContextHelper.getContext().getResources()
    ...
    public static final boolean hasCamera() {
        if (_hasCamera == null) {
            PackageManager pckMgr = ContextHelper.getContext()
                .getPackageManager();
            boolean flag = pckMgr
...
//    }
    ...
    public static boolean hasInternet() {
        boolean flag;
        if (((ConnectivityManager) ContextHelper.getContext().getSystemService(
    ...
    public static boolean isPackageExist(String pckName) {
        try {
            PackageInfo pckInfo = ContextHelper.getContext().getPackageManager()
...
//    }
    ...
    public static void hideSoftKeyboard(View view) {
        ...
        ((InputMethodManager) ContextHelper.getContext().getSystemService(
    ...
    public static boolean isLandscape() {
        boolean flag;
        if (ContextHelper.getContext().getResources().getConfiguration().orientation
            == 2) {
            flag = true;
        } else {
            flag = false;
...
//    }
    ...
    public static int getVersionCode(String packageName) {
        int versionCode = 0;
        try {
            versionCode = ContextHelper.getContext().getPackageManager()
    ...
    public static String getIMEI() {
        return CyptoUtils.encrypt("2b534");
    }
    ...
    public static void openApp(Context context, String packageName) {
        Intent mainIntent = ContextHelper.getContext().getPackageManager()
            .getLaunchIntentForPackage(packageName);
        if (mainIntent == null) {
            mainIntent = new Intent(packageName);
        } else {
            System.out.println("Action:" + mainIntent.getAction());
        }
    ...
    public static boolean isWifiOpen() {
        ...
        ConnectivityManager cm = (ConnectivityManager) ContextHelper
    ...
    public static void copyTextToBoard(String string) {
        ...
        ClipboardManager clip = (ClipboardManager) ContextHelper.getContext()
    ...
    public static int getStatuBarHeight() {
        ...
        try {
            ...
            field = c.getField("status_bar_height");
            x = Integer.parseInt(field.get(obj).toString());
            sbar = ContextHelper.getContext().getResources()
                .getDimensionPixelSize(x);
    ...
    public static int getBottomStatusBarHeight() {
    ...
    public static int getNetworkType() {
        int netType = 0;
        ConnectivityManager connectivityManager = (ConnectivityManager) ContextHelper
            .getContext().getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    public static int getNetworkState(Context context) {
        ConnectivityManager connManager = (ConnectivityManager) ContextHelper.getContext()
    ...
    */
    ...
    public static Point getScreenSize(Activity context) {
        Point out = new Point();
        int[] sizes = getRealScreenSize(context);
        out.set(sizes[0], sizes[1]);
        return out;
    }
    ...
    public static int getScreenHeightWithoutTitlebar(Context ctx) {
        ...
        return (int) (screenWidthAndHeight[1] - getStatusBarHeight(ctx) - dpToPixel(56));
    }
