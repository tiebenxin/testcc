...
import com.lensim.fingerchat.commons.dialog.effect.BaseEffects;
...
//  private static String accountJid;
...
//    }
//    if (!TextUtils.isEmpty(accountJid) && !accountJid
//        .equals(LensImUtil.getUserName())) {//切换账号，需要重置数据
//      activityName = "";
//    }
//    if (instance == null || TextUtils.isEmpty(activityName) || (!TextUtils.isEmpty(activityName)//不能兼容同一账号短时间内多次退出账号
...
//    }
//    activityName = name;
//    accountJid = LensImUtil.getUserName();
