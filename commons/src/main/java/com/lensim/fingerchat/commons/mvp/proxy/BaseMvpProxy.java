 ...
 * 代理实现类，用来管理 Presenter 的生命周期，还有和view之间的关联
 */
...
public class BaseMvpProxy<V extends BaseMvpView, P extends BaseMvpPresenter<V>> implements PresenterProxyInterface<V, P>{
    ...
    public P getMvpPresenter() {
        Log.d("mvp","Proxy getMvpPresenter");
        if (mFactory != null) {
            if (mPresenter == null) {
        ...
        Log.d("mvp","Proxy getMvpPresenter = " + mPresenter);
        return mPresenter;
    }
    ...
    private void onDetachMvpView() {
        Log.d("mvp","Proxy onDetachMvpView = ");
        if (mPresenter != null && mIsAttchView) {
    ...
    public Bundle onSaveInstanceState() {
        Log.d("mvp","Proxy onSaveInstanceState = ");
    ...
    public void onRestoreInstanceState(Bundle savedInstanceState) {
        Log.d("mvp","Proxy onRestoreInstanceState = ");
        Log.d("mvp","Proxy onRestoreInstanceState Presenter = " + mPresenter);
