...
#define PACKAGE_FRONT "com.lensim.fingerchat."//app packageName 前半部分
#define PACKAGE_END "fingerchat"  // app packageName 后半部分

#define MODULE_PACKAGE_FRONT "com.lensim.fingerchat."//MODULE packageName 前半部分
#define MOUDLE_PACKAGE_END "commons"  // MODULE packageName 后半部分

#define SIGN_FRONT_DEBUG "3082014602010130" //debug签名的第8至第15位
#define SIGN_END_DEBUG "80c617d865b6c552"   //debug签名的倒数第15位至倒数第8位
