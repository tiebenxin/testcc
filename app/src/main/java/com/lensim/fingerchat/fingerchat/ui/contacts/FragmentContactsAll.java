...
public class FragmentContactsAll extends BaseFragmentContact {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_contacts_all, null);
    }
    ...
    public void notifyResumeData() {
        ...
        if (getParent() != null && getParent().getAllRosters() != null) {
            ArrayList<UserBean> mAllRosters = new ArrayList<>();
            mAllRosters.addAll(getParent().getAllRosters());
            if (mAllRosters != null && mAllRosters.size() > 0) {
                if (mAdapter == null) {
                    initAdapter();
                }
                mAdapter.setUnreadNum(ProviderUser.getUnreadedRosterCount());//通讯类
    ...
    private void initAdapter() {
        ...
        if (listener != null) {
            mAdapter.setOnHeaderItemClick(listener);
        }
    ...
    public void setHeaderItemClickListener(IContactListener l) {
        listener = l;
    }
