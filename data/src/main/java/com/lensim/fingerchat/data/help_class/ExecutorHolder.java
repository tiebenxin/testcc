...
public class ExecutorHolder {
  ...
  private static ExecutorService PRODUCTS_EXECUTOR;
  ...
  public static synchronized ExecutorService getProductsExecutor() {
    if (PRODUCTS_EXECUTOR == null) {
      PRODUCTS_EXECUTOR = Executors.newFixedThreadPool(2);
    }
    return PRODUCTS_EXECUTOR;
  }
