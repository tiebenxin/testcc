...
public abstract class ChatPrimaryMenuBase extends RelativeLayout{
    ...
    public abstract void setSecretChat(boolean isSecret);
...
//        if (activity.getWindow().getAttributes().softInputMode != WindowManager.LayoutParams.SOFT_INPUT_STATE_ALWAYS_VISIBLE) {
//            if (activity.getCurrentFocus() != null)
//                inputManager.showSoftInputFromInputMethod(activity.getCurrentFocus().getWindowToken(),InputMethodManager.);
//        }
    }
