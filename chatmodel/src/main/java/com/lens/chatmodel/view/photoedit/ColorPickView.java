...
public class ColorPickView extends View {
     ...
     **/
    private int[] colors = {
        Color.parseColor("#ffffff"), Color.parseColor("#ff0000"), Color.parseColor("#c3a407"),
    ...
    public ColorPickView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
