...
public class FolderAdapter extends BaseAdapter {
    ...
    public FolderAdapter(Context context){
        ...
        mImageSize = mContext.getResources().getDimensionPixelOffset(R.dimen.dimen_72);
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (holder != null) {
            if(i == 0){
                ...
                if(mFolders.size()>0){
                    FolderBean f = mFolders.get(0);
                    Glide.with(mContext)
                            .load(new File(f.cover.path))
                            .error(R.drawable.default_error)
                            .override(((int) TDevice.dpToPixel(72)), ((int) TDevice.dpToPixel(72)))
                            .centerCrop()
                            .into(holder.cover);
                }
            }else {
