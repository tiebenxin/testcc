...
public class LoginConflictHandler extends BaseMessageHandler<ConflictMessage> {
    ...
    public void handle(ConflictMessage message) {
        logger.w("received LoginConflict ========>>>>>>" + message.message.getDeviceId());
        Collection<ConflictListener> conflictListeners = ClientConfig.I.getFGlistener(ConflictListener.class);
