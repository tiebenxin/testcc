...
public class XCPullToLoadMoreListView extends FrameLayout {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        mHeaderHeight = (int) TDevice.dpToPixel(50);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_CANCEL:
                if(mListView != null){
                    if(mListView.getTranslationY() >= 0){
...
//                    }
    ...
    private void upToMiddleAnim(){
        ...
        final ValueAnimator backToMiddleAnim = ValueAnimator.ofFloat(offsetY, mHeaderHeight);
        final float pullHeight = mHeaderHeight;
...
//                }
        ...
        backToMiddleAnim.setDuration((long) ((Math.abs(offsetY-mHeaderHeight)) * 600 / pullHeight));
    ...
    private void completeBackToTop(){
        ...
        int num = mListView.getAdapter().getCount() - mLastCount;//1-2
        Log.v("czm","num="+num);
        if(num > 0){
    ...
    public void setAdapter(BaseAdapter messageAdapter) {
