...
class CustomMaterialProgressDrawable extends Drawable implements Animatable {
    ...
    private final CustomMaterialProgressDrawable.Ring mRing;
    ...
    CustomMaterialProgressDrawable(Context context, View parent) {
        mParent = parent;
        mResources = context.getResources();

        mRing = new CustomMaterialProgressDrawable.Ring(mCallback);
    ...
    private void setSizeParameters(double progressCircleWidth, double progressCircleHeight,
        ...
        final CustomMaterialProgressDrawable.Ring ring = mRing;
    ...
    float getMinProgressArc(CustomMaterialProgressDrawable.Ring ring) {
     ...
     * the next color.
     */
    void updateRingColor(float interpolatedTime, CustomMaterialProgressDrawable.Ring ring) {
    ...
    void applyFinishTranslation(float interpolatedTime, CustomMaterialProgressDrawable.Ring ring) {
