...
public class TimelineView extends View {
    ...
    private void init(AttributeSet attrs) {
        ...
        mMarkerSize = typedArray
            .getDimensionPixelSize(R.styleable.timeline_style_markerSize, dpToPx(20, mContext));
        mLineSize = typedArray
            .getDimensionPixelSize(R.styleable.timeline_style_lineSize, dpToPx(2, mContext));
    ...
    private void initDrawable() {
        ...
        if (mMarkerInCenter) { //Marker in center is true
            ...
            if (mMarker != null) {
                mMarker.setBounds((width / 2) - (markSize / 2), (height / 2) - (markSize / 2),
                    (width / 2) + (markSize / 2), (height / 2) + (markSize / 2));
...
//        mMarker.setBounds(pLeft, pTop, pLeft + markSize, pTop + markSize);
                mMarker.setBounds((width / 2) - (markSize / 2), (height * 3 / 4) - (markSize / 2),
                    (width / 2) + (markSize / 2), (height * 3 / 4) + (markSize / 2));
                mBounds = mMarker.getBounds();
            }
        }
        ...
        if (mLineOrientation == 0) {
            ...
            if (mEndLine != null) {
                mEndLine
                    .setBounds(mBounds.right + mLinePadding, pTop + (mBounds.height() / 2), width,
                        (mBounds.height() / 2) + pTop + mLineSize);
            }
        } else {
            ...
            if (mEndLine != null) {
                mEndLine.setBounds(lineLeft, mBounds.bottom + mLinePadding, mLineSize + lineLeft,
                    height);
            }
        }
    }
    ...
    public void setMarkerCenter(boolean isMarkerCenter) {
        mMarkerInCenter = isMarkerCenter;
    }
