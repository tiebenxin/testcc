...
public class FavJsonDB {
    ...
    @Generated(hash = 1187342028)
    public FavJsonDB(long favId, String favMsgId, String providerJid,
            String favProvider, String providerNick, String favContent,
            String favType, String favDes, String favTime, String favCreater,
            String favCreaterAvatar, String favUrl) {
        this.favId = favId;
